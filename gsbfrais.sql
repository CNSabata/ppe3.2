...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 17 Novembre 2016 à 09:28
...
('a55', '201611', 0, '0.00', '2016-11-03', 'CR'),
('b28', '201609', 0, '0.00', '2016-10-15', 'CL'),
('b28', '201610', 0, '0.00', '2016-11-02', 'CL'),
('b28', '201611', 0, '0.00', '2016-11-02', 'CR'),
('b4', '201611', 0, '0.00', '2016-11-02', 'CR'),
('f4', '201610', 0, '0.00', '2016-10-15', 'CR');
...
(4, 'b28', '201611', 'Panne moteur', '2016-11-02', '300.00'),
(5, 'b4', '201611', 'Casse de la carrosserie', '2016-10-29', '800.00'),
(6, 'b4', '201611', 'Réparation voiture', '2016-10-30', '1200.00'),
(8, 'a55', '201611', 'Assurance déplacements et trafic', '2016-11-03', '559.89'),
(9, 'a55', '201611', 'Prélèvement auto entretien garage ', '2016-11-03', '120.00');
...
CREATE TABLE IF NOT EXISTS `visiteur` (
  ...
  `groupe` varchar(1) NOT NULL DEFAULT 'v',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('a17', 'Andre', 'David', 'test', '123', '1 rue Petit', '46200', 'Lalbenque', '1998-11-23', 'v'),
...
('b4', 'Charoze', 'Catherine', '1', '1', '100 rue Petit', '75019', 'Paris', '2005-11-12', 'v'),
...
('f4', 'Gest', 'Alain', 'admin', 'admin', '30 avenue de la mer', '13025', 'Berre', '1985-11-01', 'c');
